  ...
  const loadData = async () => {
    try {
      ...
      setAboutForm({
        ...
        solutionsTitle:
          about.solutionsTitle || 'Transforme sua gestão com nossas soluções inteligentes',
        solutionsSubtitle:
          about.solutionsSubtitle ||
      ...
      <Container maxWidth="lg">
                ...
                <TableBody>
                  {statistics.map((stat) => (
                    <TableRow key={stat.id}>
                      ...
                      <TableCell>
                        {stat.iconType === 'lucide' ? stat.icon : 'Imagem personalizada'}
                      </TableCell>
                ...
                <TableBody>
                  {solutions.map((sol) => (
                    <TableRow key={sol.id}>
                      ...
                      <TableCell>
                        {sol.iconType === 'lucide' ? sol.icon : 'Imagem personalizada'}
                      </TableCell>
        ...
        <Dialog open={statDialog} onClose={() => setStatDialog(false)} maxWidth="md" fullWidth>
                ...
                <RadioGroup
                  ...
                  onChange={(e) => {
                    setStatForm({
                      ...
                      icon: e.target.value === 'lucide' ? 'Users' : '',
                    });
                    setStatImagePreview('');
                  }}
                >
          ...
          <DialogActions>
            ...
            <Button variant="contained" onClick={handleSaveStat}>
              Salvar
            </Button>
          </DialogActions>
        </Dialog>
        ...
        <Dialog open={solDialog} onClose={() => setSolDialog(false)} maxWidth="md" fullWidth>
                ...
                <RadioGroup
                  ...
                  onChange={(e) => {
                    setSolForm({
                      ...solForm,
                      iconType: e.target.value as 'lucide' | 'image',
                      icon: e.target.value === 'lucide' ? 'BarChart2' : '',
                    });
                    setSolImagePreview('');
                  }}
                >
          ...
          <DialogActions>
            ...
            <Button variant="contained" onClick={handleSaveSol}>
              Salvar
            </Button>
          </DialogActions>
        </Dialog>
