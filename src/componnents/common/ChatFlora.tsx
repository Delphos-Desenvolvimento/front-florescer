        ...
        <>
            ...
            >
                    ...
                    <Stack direction="row" spacing={2} alignItems="center">
                        ...
                        <Box>
                            ...
                            <Typography variant="caption" sx={{ opacity: 0.9, display: 'flex', alignItems: 'center', gap: 0.5 }}>
                                <Box component="span" sx={{ width: 8, height: 8, bgcolor: '#00e676', borderRadius: '50%', display: 'inline-block' }} />
                                Online
                            </Typography>
                        </Box>
                    </Stack>
                ...
                <DialogContent sx={{
                    ...
                    <Box sx={{ flexGrow: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 2, py: 1 }}>
                        ...
                        {chatHistory.map((msg, index) => (
                            ...
                            >
                                ...
                                <Typography variant="caption" sx={{ mt: 0.5, px: 1, color: 'text.secondary', fontSize: '0.7rem' }}>
